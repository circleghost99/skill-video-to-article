...
1. 【絕對禁止純人物畫面 + 講者畫面最多 1 張】
   ...
   【講者畫面數量限制】
   如果影片是「講者＋簡報」雙畫面，優先選擇「簡報佔畫面大部分」的時刻。
   「講者佔畫面 50% 以上」的 key_frame 整部影片最多只能有 1 張（用於介紹講者身份）。
   其餘所有 key_frame 必須以投影片/UI/程式碼為畫面主體。
...
2. 【只擷取「完成畫面」— 最終狀態】
   ...
   判斷方法：如果畫面有任何文字不可辨識（模糊、被遮擋、透明度過渡），退後或推進 1-2 秒找清晰幀。
